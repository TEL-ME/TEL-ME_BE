...
public enum MemberErrorCode implements BaseErrorCode {
    ...
    EMAIL_LINK_REQUIRED(HttpStatus.CONFLICT, "MEMBER409-2", "이미 가입된 이메일 계정이 있어 비밀번호 확인 후 연결해야 합니다."),
    SOCIAL_ACCOUNT_ALREADY_LINKED(HttpStatus.CONFLICT, "MEMBER409-3", "이미 다른 소셜 계정이 연결되어 있습니다."),
    EMAIL_LOGIN_ALREADY_SET(HttpStatus.CONFLICT, "MEMBER409-4", "이미 이메일 로그인이 등록되어 있습니다.");
